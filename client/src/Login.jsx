...
//       // Chrome Google login par bhi OTP required
//       if (data.otpRequired) {
...
//         // OTP verify hone tak old authentication clear
...
//       // Non-Chrome Google login direct login
//       const role = saveAuthData(data);
...
//     const otpEmail =
//       email.trim() || localStorage.getItem("otpEmail");
...
//         <aside className="hidden flex-col justify-between px-12 py-12 text-white lg:flex xl:px-16">
//           <div className="flex items-center gap-3">
//             {/* Logo Image - Desktop Sidebar */}
//             <img 
//               src="/fav.png" 
//               alt="internArea Logo" 
...
//               Login to access opportunities, manage applications, and
//               continue your professional growth with internArea.
//             </p>
//           </div>
...
//                 {/* Logo Image - Inside Login Card (Desktop) */}
//                 <img 
//                   src="/fav.png" 
//                   alt="internArea Logo" 
...
//               <form
//                 onSubmit={showOtp ? verifyOtp : handleLogin}
//               >
//                 {/* Email */}
//                 <div className="mb-4">
...
//                       className="mb-5 text-sm font-semibold text-slate-500 hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-70"
//                     >
      ...
      <main className="relative z-10 grid min-h-screen lg:grid-cols-2">
        ...
        <aside className="hidden flex-col justify-between px-12 py-12 text-white lg:flex xl:px-16">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
              <p className="text-2xl font-bold">Fast</p>
              <p className="mt-1 text-sm text-slate-300">Applications</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
              <p className="text-2xl font-bold">Secure</p>
              <p className="mt-1 text-sm text-slate-300">Login</p>
            </div>
          </div>
        </aside>
            ...
            <div className="rounded-[2rem] border border-white/20 bg-white/95 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
              ...
              <form onSubmit={showOtp ? verifyOtp : handleLogin}>
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 px-4 py-3.5 font-bold text-white shadow-lg shadow-orange-500/25 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-orange-500/30 disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0"
                >
                  {isLoading ? (showOtp ? "Verifying..." : "Signing in...") : showOtp ? "Verify OTP" : "Sign in"}
                </button>
              </form>
