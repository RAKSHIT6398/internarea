...
//             <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 font-bold text-white shadow-lg">iA</div>
//             <div>
...
//             <span className="inline-flex rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-slate-200 backdrop-blur">Secure account recovery</span>
...
//               <p className="text-2xl font-bold">Secure</p><p className="mt-1 text-sm text-slate-300">Recovery</p>
//             </div>
//             <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
//               <p className="text-2xl font-bold">Fast</p><p className="mt-1 text-sm text-slate-300">Reset</p>
//             </div>
//             <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
//               <p className="text-2xl font-bold">Email</p><p className="mt-1 text-sm text-slate-300">Verification</p>
//             </div>
//           </div>
//         </aside>
...
//                 <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 font-bold text-white">iA</div>
//                 <div>
...
//               <Link to="/" className="mb-6 inline-flex items-center gap-2 text-sm font-semibold text-slate-500 transition hover:text-orange-600">
...
//                   <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-green-100"><CheckIcon className="h-4 w-4 text-green-600" /></span>
//                   <span>{message}</span>
//                 </div>
//               )}
...
//                   <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-red-100"><ErrorIcon className="h-4 w-4 text-red-600" /></span>
//                   <span>{error}</span>
//                 </div>
//               )}
...
//                     />
//                   </div>
//                   <p className="mt-2 text-xs text-slate-400">We’ll send reset instructions only if this email is registered.</p>
//                 </div>
...
//                 <span className="px-3 text-xs font-bold uppercase tracking-wider text-slate-400">OR</span>
//                 <div className="h-px flex-1 bg-slate-200" />
//               </div>

//               <div className="text-center text-sm text-slate-500">
//                 Remember your password?{" "}
//                 <Link to="/" className="font-bold text-orange-600 hover:text-orange-700">Login</Link>
//               </div>

//               <div className="mt-3 text-center text-sm text-slate-500">
//                 Don&apos;t have an account?{" "}
//                 <Link to="/register" className="font-bold text-orange-600 hover:text-orange-700">Create Account</Link>
//               </div>
//             </div>

//             <footer className="mt-6 text-center">
//               <p className="text-xs text-slate-400">© {new Date().getFullYear()} internArea. All rights reserved.</p>
//             </footer>
//           </div>
//         </div>
//       </main>
